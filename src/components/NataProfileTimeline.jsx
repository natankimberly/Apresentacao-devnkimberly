  ...
  return (
    <div className="relative mx-auto w-full max-w-3xl px-3 pb-2 pt-2 md:px-4">
      ...
      >
        ...
        <p className="mb-4">
          Desenvolvo aplicações Fullstack prontas para o mundo real usando{" "}
          <strong>
            JavaScript (Next.js/React), TypeScript, Node.js, PHP (Laravel),
            Python, Go, entre outras tecnologias
          </strong>
          , são um exemplo que, com ajuda das ferramentas certas (IA), podemos
