...
const Card = ({ title, icon, children, delay, x, y }) => {
  ...
  return (
    <Motion.div
      ...
      className="absolute md:w-80 w-full"
    >
      <Tilt options={defaultOptions} className="h-full">
        <div className="h-full p-6 rounded-xl bg-slate-900/80 backdrop-blur-md border border-cyan-500/20 hover:border-cyan-400/50 transition-colors shadow-lg group">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 rounded-lg bg-slate-800 text-cyan-400 group-hover:text-cyan-300 group-hover:scale-110 transition-all">
                {icon}
            </div>
    ...
    <div className="relative w-full max-w-7xl mx-auto h-[800px] md:h-[600px] flex items-center justify-center mt-20 md:mt-0">
      ...
      */}
      ...
      <div className="hidden md:block w-full h-full relative">
          ...
          {/* Top Right */}
          <Card title="Formação" icon={<BookOpen />} delay={0.4} x="350px" y="-150px">
            <ul className="list-disc pl-4 space-y-1">
                <li><strong className="text-white">Algoritmos & Lógica:</strong> Pensamento estruturado para problemas complexos.</li>
                <li><strong className="text-white">Engenharia de Software:</strong> Sistemas escaláveis e qualidade de código.</li>
                <li><strong className="text-white">Banco de Dados:</strong> Modelagem e performance.</li>
            </ul>
          </Card>

          {/* Bottom Left */}
          <Card title="Experiência" icon={<Briefcase />} delay={0.6} x="-350px" y="150px">
            <p className="mb-2"><strong className="text-white">Analista de Suporte em Transportadora Nacional:</strong></p>
            <ul className="list-disc pl-4 space-y-1">
           ...
           {/* Bottom Right */}
           <Card title="Capacidades" icon={<Cpu />} delay={0.8} x="350px" y="150px">
            <p className="mb-2 italic">"Minha jornada une a estabilidade da infraestrutura à inovação do desenvolvimento."</p>
            <p>JavaScript (Next.js/React), TypeScript, Node.js, PHP (Laravel), Python, Go, e soluções Mobile.</p>
          </Card>
      </div>
      ...
      <div className="md:hidden flex flex-col gap-6 px-4 w-full">
         ...
         <div className="bg-slate-900/80 p-6 rounded-xl border border-white/10">
            <div className="flex items-center gap-2 mb-2 text-cyan-400"><BookOpen /> <h3 className="font-bold text-white">Formação</h3></div>
             <ul className="text-slate-400 text-sm list-disc pl-4">
                <li>Algoritmos & Lógica</li>
                <li>Engenharia de Software</li>
                <li>Banco de Dados</li>
            </ul>
         </div>
         <div className="bg-slate-900/80 p-6 rounded-xl border border-white/10">
            <div className="flex items-center gap-2 mb-2 text-cyan-400"><Briefcase /> <h3 className="font-bold text-white">Experiência</h3></div>
             <ul className="text-slate-400 text-sm list-disc pl-4">
         ...
         <div className="bg-slate-900/80 p-6 rounded-xl border border-white/10">
            <div className="flex items-center gap-2 mb-2 text-cyan-400"><Cpu /> <h3 className="font-bold text-white">Capacidades</h3></div>
            <p className="text-slate-400 text-sm">Fullstack (React, Node, PHP, Python). Infraestrutura e Mobile.</p>
         </div>
      </div>
    </div>
  );
